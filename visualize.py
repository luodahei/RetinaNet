	...
	for idx, data in enumerate(dataloader_val):
		...
		with torch.no_grad():
			...
			for j in range(idxs[0].shape[0]):
				...
				label_x1 = int(label_annot[j][0])
				label_y1 = int(label_annot[j][1])
				label_x2 = int(label_annot[j][2])
				label_y2 = int(label_annot[j][3])
				draw_caption(img, (label_x1, label_y1,label_x2, label_y2), label_name)
				cv2.rectangle(img, (label_x1, label_y1), (label_x2, label_y2), color=(0, 255, 255), thickness=2)
